...
// modify by xiaohuyang, Only used to set the color of textfiled,  2020/10/27
SkColor GetColorWithMaxContrastUOS(SkColor color) {
  return IsDark(color) ? SkColorSetRGB(0xE6, 0xE6, 0xE6) : g_darkest_color;
}
