...
COMPONENT_EXPORT(UI_BASE_X) SharedMemorySupport QuerySharedMemorySupport(XDisplay* dpy);
...
COMPONENT_EXPORT(UI_BASE_X)
XSharedMemoryId AttachSharedMemory(XDisplay* display, int shared_memory_support);
