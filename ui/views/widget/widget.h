...
#ifdef USE_UNIONTECH_NPAPI
    // npapi plugin observers of the widget
    std::vector<NpapiPluginMaskObserver* > npapi_plugin_mask_observers;
#endif
  };
...
#ifdef USE_UNIONTECH_NPAPI
  NpapiPluginMask* GetNpapiPuginMask() {
      return npapi_plugin_mask_.get();
  }
#endif
...
#ifdef USE_UNIONTECH_NPAPI
  // used for dig holes in npapi plugin window
  std::unique_ptr<NpapiPluginMask> npapi_plugin_mask_;
#endif
