...
namespace ui {
class MouseEvent;
class TouchEvent; //wangfeng: add touch event, 2020/08/11
...
class VIEWS_EXPORT WindowEventFilterLinux {
 public:
  ...
  //wangfeng: add touch event handler, 2020/08/11
  void HandleTouchEventWithHitTest(int hit_test, ui::TouchEvent* event);
 ...
 private:
  ...
  //wangfeng: add touch event dispatch, 2020/08/11
  void MaybeDispatchHostWindowDragMovement(int hittest, ui::TouchEvent* event);
