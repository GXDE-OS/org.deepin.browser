...
/***********************************************************************************
*                                                                                  *
*  @file     message_box_view_xdg.h                                                *
*  @brief    Copy from 'message_box_view.h' in order to create a message box view  *
*        for xdg_open bubble dialog, be unsed in 'external_protocol_dialog.h'.     *
*                                                                                  *
*  @author   xiaohuyang                                                            *
*  @email    yangxiaofu@uniontech.com                                              *
*  @date     2020/11/24                                                            *
*                                                                                  *
***********************************************************************************/
...
// and Cancel buttons.
class VIEWS_EXPORT XdgMessageBoxView : public View {
 public:
  METADATA_HEADER(XdgMessageBoxView);
  ...
  explicit XdgMessageBoxView(const InitParams& params);

  ~XdgMessageBoxView() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(XdgMessageBoxView);
};
