...
///////////////////////////////////////////////////////////////////////////////
// XdgMessageBoxView, public:

XdgMessageBoxView::InitParams::InitParams(const base::string16& message)
    : options(NO_OPTIONS),
      message(message),
...
XdgMessageBoxView::InitParams::~InitParams() = default;

XdgMessageBoxView::XdgMessageBoxView(const InitParams& params)
    : inter_row_vertical_spacing_(params.inter_row_vertical_spacing),
      message_width_(params.message_width) {
  Init(std::move(params));
}

XdgMessageBoxView::~XdgMessageBoxView() = default;

base::string16 XdgMessageBoxView::GetInputText() {
  return prompt_field_ ? prompt_field_->GetText() : base::string16();
}

bool XdgMessageBoxView::IsCheckBoxSelected() {
  return checkbox_ && checkbox_->GetChecked();
}

void XdgMessageBoxView::SetCheckBoxLabel(const base::string16& label) {
  if (checkbox_) {
...
void XdgMessageBoxView::SetCheckBoxSelected(bool selected) {
  if (!checkbox_)
    return;
  checkbox_->SetChecked(selected);
}

void XdgMessageBoxView::SetLink(const base::string16& text,
...
void XdgMessageBoxView::GetAccessibleNodeData(ui::AXNodeData* node_data) {
  node_data->role = ax::mojom::Role::kAlertDialog;
}

///////////////////////////////////////////////////////////////////////////////
// XdgMessageBoxView, View overrides:

void XdgMessageBoxView::ViewHierarchyChanged(
...
bool XdgMessageBoxView::AcceleratorPressed(const ui::Accelerator& accelerator) {
...
///////////////////////////////////////////////////////////////////////////////
// XdgMessageBoxView, private:

void XdgMessageBoxView::Init(const InitParams& params) {
...
void XdgMessageBoxView::ResetLayoutManager() {
...
gfx::Insets XdgMessageBoxView::GetHorizontalInsets(
...
BEGIN_METADATA(XdgMessageBoxView)
