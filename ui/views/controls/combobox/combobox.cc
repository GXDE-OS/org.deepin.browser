...
void Combobox::PaintText(gfx::Canvas* canvas) {
  ...
  //modify by xiaohuyang, Set the style of the drop-down button of ‘Combobox’, 2021/3/6  --start
#if UNUSED
  ...
  PaintComboboxArrow(text_color, arrow_bounds, canvas, icon);
#endif
  //modify by xiaohuyang, Set the style of the drop-down button of ‘Combobox’, 2021/3/6  --end
}
