...
class VIEWS_EXPORT TreeView : public View,
 ...
 private:
  ...
  // modify by xiaohuyang, Only used to paint arrow icon(expand control). 2021/2/5
  void PaintExpandControlUOS(gfx::Canvas* canvas,
                          const gfx::Rect& node_bounds,
                          InternalNode* node);
  ...
  //add by xiepinze, cookie selected item ui modify, 20201217, start
  // Paints the expand control given the specified node.
  void PaintExpandControlWithNode(InternalNode* node,
                                  gfx::Canvas* canvas,
                                  const gfx::Rect& node_bounds,
                                  bool expanded);
  //add by xiepinze, cookie selected item ui modify, 20201217, end
