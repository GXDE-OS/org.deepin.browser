...
#include "ui/gtk2/gtk_key_bindings_handler.h"
#include "ui/gtk2/gtk_ui_delegate.h"
#include "ui/gtk2/gtk_util.h"
#include "ui/gtk2/input_method_context_impl_gtk.h"
#include "ui/gtk2/native_theme_gtk.h"
//#include "ui/gtk2/nav_button_provider_gtk.h"
#include "ui/gtk2/print_dialog_gtk.h"
#include "ui/gtk2/printing_gtk_util.h"
#include "ui/gtk2/select_file_dialog_impl.h"
#include "ui/gtk2/settings_provider_gtk.h"
...
#if defined(USE_GIO)
#include "ui/gtk2/settings_provider_gsettings.h"
#endif
...
void GtkUi::UpdateColors() {
  ...
  inactive_selection_bg_color_ = GetSelectionBgColor(
      0 ? "GtkTextView#textview.view:backdrop "
                               "#text:backdrop #selection:backdrop"
                             : "GtkTextView.view:selected:backdrop");
  inactive_selection_fg_color_ =
      GetFgColor(0 ? "GtkTextView#textview.view:backdrop "
                                          "#text:backdrop #selection:backdrop"
                                        : "GtkTextView.view:selected:backdrop");
