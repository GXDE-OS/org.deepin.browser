...
void SettingsProviderGtk::SetWindowButtonOrderingFromGtkLayout(
  ...
  //wangjuna: add logo at left corner, 2020/07/23, --start
#if 0
  ParseButtonLayout(gtk_layout, &leading_buttons, &trailing_buttons);
#else
  std::string _gtk_layout = "logo:minimize,maximize,close";
  ParseButtonLayout(_gtk_layout, &leading_buttons, &trailing_buttons);
#endif
  //wangjuna: add logo at left corner, 2020/07/23, --end
