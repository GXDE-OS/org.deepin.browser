...
void HttpCache::OnExternalCacheHit(
  ...
  {
    // fprintf(stderr,"return OnExternalCacheHit!%s\n",url.host().c_str());
    return;
  }

  // fprintf(stderr,"continue OnExternalCacheHit!%s\n",url.host().c_str());
...
int HttpCache::CreateTransaction(
  ...
  //fprintf(stderr,"CreateTransaction!\n");
...
int HttpCache::DoneWithResponseHeaders(ActiveEntry* entry,
  ...
  // write.
  //fprintf(stderr,"DoneWithResponseHeaders!\n");
...
void HttpCache::ProcessDoneHeadersQueue(ActiveEntry* entry) {
  //fprintf(stderr,"ProcessDoneHeadersQueue!\n");
...
void HttpCache::AddTransactionToWriters(
  ...
  //fprintf(stderr,"AddTransactionToWriters!\n");
  if (!entry->writers) {
