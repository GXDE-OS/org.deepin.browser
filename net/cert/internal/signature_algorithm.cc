...
const uint8_t kOidSM2WithSM3[] = { 0x2A, 0x81, 0x1C, 0xCF, 0x55, 0x01, 0x83, 0x75 };
#endif
...
// GMTLS leiyuanxiang
#ifndef OPENSSL_NO_GMTLS  
   if (oid == der::Input(kOidSM2WithSM3))
    return ParseEcdsa(DigestAlgorithm::SM3, params);
#endif
...
// GMTLS leiyuanxiang
#ifndef OPENSSL_NO_GMTLS  
bool SignatureAlgorithm::SM3WithSM2(const der::Input& algorithm_identifier) 
{
  der::Input oid;
  der::Input params;
  if (!ParseAlgorithmIdentifier(algorithm_identifier, &oid, &params))
  ...
  return oid == der::Input(kOidSM2WithSM3);
}
#endif
}  // namespace net
