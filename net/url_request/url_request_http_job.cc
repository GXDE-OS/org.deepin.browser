...
void URLRequestHttpJob::OnStartCompleted(int result) {
  ...
  if (result == OK) {
    ...
    // net::HttpCache *cache = context->http_transaction_factory()->GetCache();
    // cache->set_mode(net::HttpCache::Mode::DISABLE);
    // fprintf(stderr,"OnStartCompleted CLIENT_AUTH_CERT_NEEDED!%d\n",cache->mode());
