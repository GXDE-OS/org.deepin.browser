...
//modify by xiaohuyang, Handle the task of #77070. 2021/6/10 --start
//Fixed use of the search engine collection in the CN environment.
#if UNUSED
...
#else
// China
//According to product requirements, set up the collection of search engines used in the ‘CN’ environment.
const PrepopulatedEngine* const engines_CN[] = {
    &baidu,
    &sogou,
    &so_360,
...
#endif
//modify by xiaohuyang, Handle the task of #77070. 2021/6/10 --end
// ----------------------------------------------------------------------------
...
#else
  engines = engines_CN;                 
  num_engines = base::size(engines_CN);
#endif
  //modify by xiaohuyang, Handle the task of #77070. 2021/6/10 --end
