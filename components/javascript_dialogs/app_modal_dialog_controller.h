...
class AppModalDialogController {
 public:
  ...
  //modify by xiaohuyang, Handle the task of #82352.
  void cancel(bool suppress_js_messages);
  void no(const base::string16& prompt_text, bool suppress_js_messages);
  void yes(const base::string16& prompt_text, bool suppress_js_messages);
  ...
  //modify by xiaohuyang, Handle the task of #82352.
  bool is_tab_close() { return is_tab_close_; }
  base::string16 bank_and_irc() const { return bank_and_irc_; }
 ...
 private:
  ...
  //modify by xiaohuyang, Handle the task of #82352.
  bool is_tab_close_;
  const base::string16 bank_and_irc_;
