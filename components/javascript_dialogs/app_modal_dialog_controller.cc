...
//modify by xiaohuyang, Handle the task of #82352.
void AppModalDialogController::cancel(bool suppress_js_messages) {
  CompleteDialog();
  NotifyDelegate(false, base::string16(), suppress_js_messages);
}

//modify by xiaohuyang, Handle the task of #82352.
void AppModalDialogController::no(const base::string16& prompt_text,
                                        bool suppress_js_messages) {
  CompleteDialog();
...
//modify by xiaohuyang, Handle the task of #82352.
void AppModalDialogController::yes(const base::string16& prompt_text, bool suppress_js_messages) {
  CompleteDialog();
  NotifyDelegate(false, prompt_text, suppress_js_messages);
  web_contents_->DispatchUosCustomizedEvent();
}
