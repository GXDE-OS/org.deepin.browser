...
base::LazyInstance<ChromeContentPluginClient>::DestructorAtExit
...
#else
    content::kChromeDevToolsScheme, content::kChromeUIScheme, content::kUosUIScheme,
#endif
...
bool HandleVersionSwitches(const base::CommandLine& command_line) {
  ...
  if (command_line.HasSwitch(switches::kVersion)) {
    printf("%s %s %s\n", version_info::GetProductName().c_str(),
           version_info::GetUOSVersionNumber().c_str(),
