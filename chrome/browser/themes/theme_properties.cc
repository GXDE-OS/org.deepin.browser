...
SkColor GetLightModeColor(int id) {
  ...
  switch (id) {
...
#endif
      //wangfeng: modify, Change the tab background color to white, 2020/08/21 --start
      return SK_ColorWHITE;
      //wangfeng: modify, Change the tab background color to white, 2020/08/21 --end
    ...
    case ThemeProperties::COLOR_WINDOW_CONTROL_BUTTON_BACKGROUND_INACTIVE:
      return color_utils::HSLShift(
          ...
          ThemeProperties::GetDefaultTint(ThemeProperties::TINT_FRAME_INACTIVE,
                                          false));
    //modify by xiepinze, default browser infobar color, 2020/09/04, start
    case ThemeProperties::COLOR_INFOBAR:
      return gfx::kGoogleGrey300;
    case ThemeProperties::COLOR_INFOBAR_TXT:
    ...
    case ThemeProperties::COLOR_TAB_BACKGROUND_ACTIVE_FRAME_INACTIVE:
      ...
      return SK_ColorWHITE;
#endif
    //modify by xiepinze, default browser infobar color, 2020/09/04, end
      //wangfeng: modify, Change the tab color to snow white, 2020/08/21 --start
      return SkColorSetRGB(250, 250, 250);
      //wangfeng: modify, Change the tab color to snow white, 2020/08/21 --end
