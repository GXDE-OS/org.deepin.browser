...
/**
 * @param {!chrome.developerPrivate.ExtensionInfo} extensionInfo
 * @return {boolean} Whether the extension is uos default extension.
 */
export function isUosExtensionNoDelete(extensionInfo) {
  console.log(extensionInfo);
  return extensionInfo.isUosExtensionNoDelete || !!extensionInfo.controlledInfo;
}
/**
 * @param {!chrome.developerPrivate.ExtensionInfo} extensionInfo
 * @return {boolean} Whether the extension is uos default extension.
 */
export function isUosExtensionNoDisable(extensionInfo) {
  console.log(extensionInfo);
  return extensionInfo.isUosExtensionNoDisable || !!extensionInfo.controlledInfo;
}
/**
 * @param {!chrome.developerPrivate.ExtensionInfo} extensionInfo
 * @return {boolean} Whether the extension is uos default extension.
 */
export function isUosExtensionWebuiVisiable(extensionInfo) {
  console.log(extensionInfo);
  return extensionInfo.isUosExtensionWebuiVisiable || !!extensionInfo.controlledInfo;
}
