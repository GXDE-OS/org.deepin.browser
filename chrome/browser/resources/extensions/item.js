...
import {computeInspectableViewLabel, EnableControl, getEnableControl, getItemSource, getItemSourceString, isControlled, isUosExtensionNoDelete, isUosExtensionNoDisable, isUosExtensionWebuiVisiable, isEnabled, SourceType, userCanChangeEnablement} from './item_util.js';
...
Polymer({
   ...
   * @private
   */
  isUosExtensionNoDelete_() {
    return isUosExtensionNoDelete(this.data);
  },
  /**
   * @return {boolean}
   * @private
   */
  isUosExtensionNoDisable_() {
    return isUosExtensionNoDisable(this.data);
  },
  /**
   * @return {boolean}
   * @private
   */
  isUosExtensionWebuiVisiable_() {
    return isUosExtensionWebuiVisiable(this.data);
  },
  /**
   * @return {boolean}
   * @private
