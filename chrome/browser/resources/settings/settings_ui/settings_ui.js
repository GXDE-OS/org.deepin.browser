  ...
  Polymer({
    ...
    attached() {
      ...
      const scrollToTop = top => new Promise(resolve => {
        ...
        //   this.$.container.querySelector('settings-main').shadowRoot.querySelector('#overscroll').classList.add("noscroll");
        // }else {
        //   this.$.container.querySelector('settings-main').shadowRoot.querySelector('#overscroll').classList.remove("noscroll");
        // }
