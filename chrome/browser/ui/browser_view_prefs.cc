...
//modify by xiepinze, don't use system title bar, 2020/07/25, start
/*
...
*/
  registry->RegisterBooleanPref(prefs::kUseCustomChromeFrame, true);
//modify by xiepinze, don't use system title bar, 2020/07/25, end
}
