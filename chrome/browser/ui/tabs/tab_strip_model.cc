...
bool TabStripModel::IsContextMenuCommandEnabled(
  ...
  switch (command_id) {
    ...
    //modify by xiaohuyang, reload all tabs, set action whether enable, one tab - disable, other - enable. 2020/07/09 --start
    ...
    //modify by xiaohuyang, reload all tabs, set action whether enable, one tab - disable, other - enable. 2020/07/09 --end
...
void TabStripModel::ExecuteContextMenuCommand(int context_index,
  ...
  switch (command_id) {
    ...
    //modify by xiaohuyang, add reload all tabs function, clicked this action reload all web pages. 2020/07/09 --start
    case CommandReloadAll: {
      base::RecordAction(UserMetricsAction("TabContextMenu_ReloadAll"));
      for (int i = count() - 1; i >= 0; --i){
        WebContents *tab = GetWebContentsAt(i);
        if(tab){
          Browser *browser = chrome::FindBrowserWithWebContents(tab);
    ...
    //modify by xiaohuyang, add reload all tabs function, clicked this action reload all web pages. 2020/07/09 --end
