...
void WebAppMenuModel::Build() {
  //modify by xiepinze, app browser menu modify, 20201029, start
...
// option in the app menu.
  ...
  //CreateZoomMenu();
  zoom_menu_level_item_model_ = std::make_unique<ZoomLevelMenuModel>(this, browser());
  AddSubMenuWithStringId(IDC_ZOOM_LEVEL_MENU, IDS_ZOOM_MENU, zoom_menu_level_item_model_.get());
 ...
 // AddSeparator(ui::LOWER_SEPARATOR);
  ...
  //modify by xiepinze, app browser menu modify, 20201029, end
}
