...
void CertificateViewerDialog::GetDialogSize(gfx::Size* size) const {
  //modify by xiaohuyang, Set the width of certificate dialog,  2020/09/27 --start
#if 0
  const int kDefaultWidth = 544;
#else
  const int kDefaultWidth = 522;
#endif
  //modify by xiaohuyang, Set the width of certificate dialog,  2020/09/27 --end
