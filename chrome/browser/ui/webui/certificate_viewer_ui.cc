...
content::WebUIDataSource* GetWebUIDataSource(const std::string& host) {
  ...
  static constexpr webui::LocalizedString kStrings[] = {
      //modify by xiaohuyang, Modify some strings in the certificate pop-up window, 2020/09/19  --start
#if 0
...
#else
      {"general", IDS_CERT_INFO_GENERAL_TAB_LABEL_UOS},
      {"details", IDS_CERT_INFO_DETAILS_TAB_LABEL_UOS},
      {"close", IDS_CLOSE},
      {"export", IDS_SETTINGS_CERTIFICATE_MANAGER_EXPORT},
#endif
      //modify by xiaohuyang, Modify some strings in the certificate pop-up window, 2020/09/19  --end
