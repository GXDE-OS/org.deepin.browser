...
void AddCommonStrings(content::WebUIDataSource* html_source, Profile* profile) {
  static constexpr webui::LocalizedString kLocalizedStrings[] = {
    ...
    {"usbkeydriverManagerAddDriverDialogTitle",
       IDS_SETTINGS_USBKEYDRIVER_MANAGER_ADD_DRIVER_DIALOG_TITLE},
    {"usbkeydriverManagerDriverEdit",
       IDS_SETTINGS_USBKEYDRIVER_MANAGER_DRIVER_EDIT},
    ...
    {"usbkeydriverStateCryptProtocol",
      IDS_SETTINGS_STATE_CRYPT_PROTOCOL},//
    {"usbkeydriverMore",
      IDS_CONTENT_CONTEXT_MORE_APPS},//
#if !defined(OS_CHROMEOS)
...
void AddAppearanceStrings(content::WebUIDataSource* html_source,
  ...
  static constexpr webui::LocalizedString kLocalizedStrings[] = {
    ...
    {"uosLightTheme", IDS_SETTINGS_UOS_LIGHT_THEME},
    {"uosDarkTheme", IDS_SETTINGS_UOS_DARK_THEME},
    {"uosSystemTheme", IDS_SETTINGS_UOS_SYSTEM_THEME},
...
//modify by xiepinze, do not track text modify, 20201105, start
//  html_source->AddString(
...
//#endif
  base::string16 str = l10n_util::GetStringFUTF16(
          IDS_SETTINGS_ENABLE_DO_NOT_TRACK_DIALOG_TEXT,
          base::ASCIIToUTF16(chrome::kDoNotTrackLearnMoreURL));
  auto i = str.find_first_of('<');
  str.erase(i);
  html_source->AddString("doNotTrackDialogMessage", str);
//modify by xiepinze, do not track text modify, 20201105, end
  html_source->AddString(
...
void AddSearchEnginesStrings(content::WebUIDataSource* html_source) {
  static constexpr webui::LocalizedString kLocalizedStrings[] = {
      ...
      {"searchEnginesQueryURLExplanationNew",
       IDS_SETTINGS_SEARCH_ENGINES_QUERY_URL_EXPLANATION_NEW},
      {"LocationBarsearchEnginesTIP",
       IDS_SETTINGS_SEARCH_ENGINES_TIP},
      {"searchEnginesName",
       IDS_SETTINGS_SEARCH_ENGINES_NAME},
      {"aboutProductSource",
       IDS_SETTINGS_ABOUT_PRODUCT_SOURCE},
      // {"cancel",
      //  IDS_SETTINGS_CANCEL},
  };
  AddLocalizedStringsBulk(html_source, kLocalizedStrings);
...
void AddSiteSettingsStrings(content::WebUIDataSource* html_source,
 ...
 //modify by hanll,增加 “所有Cookie，仅限在此网站上”选项, start
#if 0
  html_source->AddBoolean(
...
#else
  html_source->AddBoolean(
      "showImprovedCookieControlsForThirdParties",true);
#endif
  //modify by hanll,增加 “所有Cookie，仅限在此网站上”选项, end
...
void AddBrowserLocalizedStrings(content::WebUIDataSource* html_source,
  ...
  // add by hanll, 添加‘重新启动’按钮判断逻辑, 2020/11/25, start
  html_source->AddBoolean("nationalsslEnabledAtStartup",
      profile->GetPrefs()->GetBoolean(bookmarks::prefs::kShowGM));
  // add by hanll, 添加‘重新启动’按钮判断逻辑, 2020/11/25, end
#endif
