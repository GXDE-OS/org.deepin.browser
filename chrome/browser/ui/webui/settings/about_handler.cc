...
AboutHandler* AboutHandler::Create(content::WebUIDataSource* html_source,
                                   Profile* profile) {
  // @wangjun: add chromium version in about page, 2021/04/26
  base::string16 extra = base::UTF8ToUTF16("| ") + base::UTF8ToUTF16(version_info::GetVersionNumber());

  html_source->AddString(
      "aboutBrowserVersion",
      l10n_util::GetStringFUTF16(
          IDS_SETTINGS_ABOUT_PAGE_BROWSER_VERSION,
          base::UTF8ToUTF16(version_info::GetUOSVersionNumber()),
