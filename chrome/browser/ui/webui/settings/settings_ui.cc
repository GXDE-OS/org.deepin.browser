...
SettingsUI::SettingsUI(content::WebUI* web_ui)
...
#ifndef OPENSSL_NO_GMTLS
  AddSettingsPageUIHandler(
      std::make_unique<usbkeydriver_manager::USBKeyDriverHandler>(profile));
#endif //#OPENSSL_NO_GMTLS
  ...
  //新增start
  // html_source->AddResourcePath("images/deepin_cloudprint_config_helper.svg",
  //                              IDR_SETTINGS_IMAGES_DEEPIN_CLOUDPRINT_CONFIG_HELPER_SVG);
  // html_source->AddResourcePath(
  //     "images/notification_network_wireless_full.svg",
  //     IDR_SETTINGS_IMAGES_NOTIFICATION_NETWORK_WIRELESS_FULL_SVG);  
  //新增end
