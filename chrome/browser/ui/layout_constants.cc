...
int GetLayoutConstant(LayoutConstant constant) {
  ...
  switch (constant) {
    ...
    case LOCATION_BAR_ELEMENT_PADDING:
      return touch_ui ? 3 : 2;
    // modify by xiaohuyang, Set height,padding and spacing for toolbar Control, 2020/08/07 --start
#if UNUSED
    ...
    case TAB_ALERT_INDICATOR_ICON_WIDTH:
      return touch_ui ? 12 : 16;
    case TAB_HEIGHT:
      // modify by xiaohuyang, fix bug#78611.
      // For self_developed browsers, the best tab height is 46.
      return (touch_ui ? 41 : 46) + GetLayoutConstant(TABSTRIP_TOOLBAR_OVERLAP);
    case TAB_PRE_TITLE_PADDING:
      return 8;
    case TAB_STACK_DISTANCE:
      return touch_ui ? 4 : 6;
    ...
    case TOOLBAR_ELEMENT_PADDING:
      return touch_ui ? 0 : 10;
    case TOOLBAR_STANDARD_SPACING:
      return touch_ui ? 12 : 10;
#endif
    // modify by xiaohuyang, Set height,padding and spacing for toolbar Control, 2020/08/07 --end
    default:
      break;
  }
  NOTREACHED();
...
gfx::Insets GetLayoutInsets(LayoutInset inset) {
  ...
  switch (inset) {
    ...
    // modify by xiaohuyang, Set the padding between the icon and the border, 2020/08/07 --start
    case TOOLBAR_BUTTON:
      // return gfx::Insets(touch_ui ? 12 : 6);
      return gfx::Insets(touch_ui ? 12 : 10);   
    // modify by xiaohuyang, Set the padding between the icon and the border, 2020/08/07 --end
