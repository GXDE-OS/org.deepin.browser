...
class SessionCrashedBubble {
 public:
  ...
  static views::Widget* GetSessionCrashedBubbleWidget() { return widget; }

  static void ReplaySessionCrashedBubbleWidget();

  virtual ~SessionCrashedBubble() { widget = nullptr;}

  static views::Widget* widget;
