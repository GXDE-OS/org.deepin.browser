...
enum AppMenuAction {
  ...
  MENU_ACTION_UOS_THEME = 51,
  MENU_ACTION_UOS_THEME_LIGHT = 52,
  MENU_ACTION_UOS_THEME_DARK = 53,
  MENU_ACTION_UOS_THEME_SYSTEM = 54,
...
class ZoomLevelMenuModel : public ui::SimpleMenuModel {
 public:
  ZoomLevelMenuModel(ui::SimpleMenuModel::Delegate* delegate, Browser* browser);
  ~ZoomLevelMenuModel() override;

 private:
  void Build(Browser* browser);

  DISALLOW_COPY_AND_ASSIGN(ZoomLevelMenuModel);
};
//add by xiepinze, add page zoom submenu, 2020/08/03, end

//add by xiepinze uos theme, 2020/07/24 start
class UosThemeMenuModel : public ui::SimpleMenuModel {
 public:
  UosThemeMenuModel(ui::SimpleMenuModel::Delegate* delegate, Browser* browser);
  ~UosThemeMenuModel() override;

 private:
  void Build(Browser* browser);

  DISALLOW_COPY_AND_ASSIGN(UosThemeMenuModel);
};
//add by xiepinze uos theme, 2020/07/24 end
...
class AppMenuModel : public ui::SimpleMenuModel,
 ...
 private:
  ...
  //add by xiepinze uos theme, 2020/07/24 start
  std::unique_ptr<UosThemeMenuModel> uos_theme_menu_model_;
  //add by xiepinze uos theme, 2020/07/24 end
  //add by xiepinze, add page zoom submenu, 2020/08/03, start
