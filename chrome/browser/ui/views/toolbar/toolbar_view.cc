...
void ToolbarView::Init() {
  ...
  //modify by wangjuna, hide google account login button, 2020/07/08 --start
  //bool show_avatar_toolbar_button = true;
  bool show_avatar_toolbar_button = false;
  //modify by wangjuna, hide google account login button, 2020/07/08 --end
#if defined(OS_CHROMEOS)
  ...
  if (show_avatar_toolbar_button || browser_->profile()->IsIncognitoProfile())
...
void ToolbarView::UpdateCustomTabBarVisibility(bool visible, bool animate) {
  ...
  // modify by fangzhouyang, do not show location bar in quick version of IQIYI, 2021/3/22 --start
  if(visible && (display_mode_ == DisplayMode::CUSTOM_TAB)){
    return;
  }
  // modify by fangzhouyang, do not show location bar in quick version of IQIYI, 2021/3/22 --end
  if (!animate) {
...
void ToolbarView::LayoutCommon() {
  ...
  // modify by xiaohuyang, Set left and right margin when the main window of browser is maximized, 2020/08/07 --start
  #if 0
  ...
  app_menu_button_->SetTrailingMargin(0);
  #endif
  // modify by xiaohuyang, Set left and right margin when the main window of browser is maximized, 2020/08/07 --end
