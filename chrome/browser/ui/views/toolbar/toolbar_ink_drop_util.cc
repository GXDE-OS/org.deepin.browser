...
class ToolbarButtonHighlightPathGenerator
 ...
 public:
  ...
  SkPath GetHighlightPath(const views::View* view) override {
    ...
    // modify by xiaohuyang, Set a round rect background for toolbar button, 2020/08/07 --start
    #if 0
    ...
    const int radii = 8;
    #endif
    // modify by xiaohuyang, Set a round rect background for toolbar button, 2020/08/07 --end
