...
class ExtensionUninstallDialogDelegateView
 ...
 private:
  ...
  // modify by xiaohuyang, Dispaly window icon and close button, 2020/10/26 --start
#if 0
  bool ShouldShowCloseButton() const override { return false; }
  gfx::ImageSkia GetWindowIcon() override { return image_; }
#else
  gfx::ImageSkia GetWindowIcon() override { return *(ui::ResourceBundle::GetSharedInstance().GetImageSkiaNamed(IDR_PERMISSION_PROMPT_BUBBLE_VIEW_ICON)); }
  bool ShouldShowCloseButton() const override { return true; }
#endif
  // modify by xiaohuyang, Dispaly window icon and close button, 2020/10/26 --end
...
ExtensionUninstallDialogDelegateView::ExtensionUninstallDialogDelegateView(
  ...
  // modify by xiaohuyang, Set the new style of ExtensionUninstallDialogDelegateView, title centered display， 2020/10/26 --start
#if 0
  ...
  // modify by xiaohuyang, Set margins.
  set_margins(gfx::Insets(kContentMargins, kContentMarginBottom, kContentMarginBottom, kContentMarginBottom));
#endif
  
  auto dialog_title_label =
        new views::Label(l10n_util::GetStringFUTF16(IDS_EXTENSION_PROMPT_UNINSTALL_TITLE,
                                    extension_name_), CONTEXT_BODY_TEXT_LARGE);
...
// modify by xiaohuyang, Do not dispaly window title, 2020/10/26 --start
#if 0
...
#endif
// modify by xiaohuyang, Do not dispaly window title, 2020/10/26 --end
