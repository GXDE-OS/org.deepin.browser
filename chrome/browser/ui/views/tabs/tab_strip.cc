...
void TabStrip::UpdateContrastRatioValues() {
  ...
  // modify by xiaohuyang, Use color to set a new style of tab separator, 2020/10/29 --start
#if 0
...
#else
  if(controller_.get()->GetBrowser()->profile()->IsIncognitoProfile() || 
  GetNativeTheme()->ShouldUseDarkColors()){
    separator_color_ = SkColorSetRGB(0x51, 0x51, 0x51);
  } else {
    separator_color_ = SkColorSetRGB(0xE5, 0xE5, 0xE5);
  }
#endif
  // modify by xiaohuyang, Use color to set a new style of tab separator, 2020/10/29 --end
}
