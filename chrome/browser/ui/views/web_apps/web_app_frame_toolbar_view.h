...
class WebAppFrameToolbarView : public views::AccessiblePaneView,
 ...
 public:
  ...
  //add by xiepinze, add public api to get BrowserView, 20201028, start
  BrowserView* GetBrowserView() { return browser_view_; }
  //add by xiepinze, add public api to get BrowserView, 20201028, end
 protected:
