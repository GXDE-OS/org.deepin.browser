...
WebAppUninstallDialogDelegateView::WebAppUninstallDialogDelegateView(
  ...
  // modify by xiaohuyang, Set the new style of 'WebAppUninstallDialogDelegateView', 2020/12/11 --start
  ...
  ChromeLayoutProvider* layout_provider = ChromeLayoutProvider::Get();
  views::GridLayout* content_layout 
       = SetLayoutManager(std::make_unique<views::GridLayout>());
       
  const int column_set_id = 0;
  views::ColumnSet* columns = content_layout->AddColumnSet(column_set_id);
  ...
  content_layout->StartRow(views::GridLayout::kFixedSize, column_set_id);
  content_layout->AddView(std::move(title_label), 1.0, 1.0,
  ...
  content_layout->StartRowWithPadding(views::GridLayout::kFixedSize, column_set_id,
                              views::GridLayout::kFixedSize,
                              5);
  checkbox_ = content_layout->AddView(std::move(checkbox), 1.0, 1.0,
                      views::GridLayout::CENTER, views::GridLayout::CENTER);
  ...
  ProcessAutoConfirmValue();
#endif
  // modify by xiaohuyang, Set the new style of 'WebAppUninstallDialogDelegateView', 2020/12/11 --end
}
