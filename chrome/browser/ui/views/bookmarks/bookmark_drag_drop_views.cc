...
class BookmarkDragImageSource : public gfx::CanvasImageSource {
 public:
  ...
  //modify by xiepinze, set bookmark drag background, 20201126, start
  //static constexpr SkColor kContainerColor = gfx::kGoogleBlue500;
  static constexpr SkColor kContainerColor = SkColorSetRGB(123, 188, 251);
  //modify by xiepinze, set bookmark drag background, 20201126, end
 ...
 private:
  ...
  void Draw(gfx::Canvas* canvas) override {
    ...
    canvas->DrawRoundRect(container_rect, 8, paint_flags);
    //modify by xiepinze, set bookmark drag background, 20201126, end
    ...
    canvas->DrawStringRectWithFlags(title_, font_list, SK_ColorBLACK, text_rect,
                                    gfx::Canvas::TEXT_ALIGN_LEFT);
    //modify by xiepinze, set bookmark drag background, 20201126, end
