...
class BookmarkBarView : public views::AccessiblePaneView,
 ...
 private:
  ...
  std::unique_ptr<views::Label> CreateEmptyBookmarkLabel();
  ...
  // add by hanll, 增加显示您的收藏夹是空的提示, 2020/08/18, start
  // Returns true, means root node has no user add bookmark node.
  bool CheckBookmarksIsEmpty();
  // add by hanll, 增加显示您的收藏夹是空的提示, 2020/08/18, end
  ...
  views::Label* emptybookmark_tooltip_label_ = nullptr;
