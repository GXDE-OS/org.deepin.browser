...
MessageBoxDialog::MessageBoxDialog(const base::string16& title,
    ...
    : window_title_(title),
      ...
      //     views::MessageBoxView::InitParams(message).dialog_title = title)),
      is_system_modal_(is_system_modal) {
  views::MessageBoxView::InitParams params(message);
  params.dialog_title = window_title_;
...
gfx::ImageSkia MessageBoxDialog::GetWindowIcon() {
...
bool MessageBoxDialog::ShouldShowWindowIcon() const {
  return true;
}
