...
void KeywordHintView::OnThemeChanged() {
  ...
  // modify by xiaohuyang, fix bug#79441,  2021/05/25  --start
  // Set the border of the right-angled rectangle for the 'Tab'.
#if UNUSED
  ...
  chip_container_->SetBackground(CreateBackgroundFromPainter(
      views::Painter::CreateRoundRectWith1PxBorderPainter(
          ...
          views::LayoutProvider::Get()->GetCornerRadiusMetric(
              views::EMPHASIS_NONE))));
#endif
  // modify by xiaohuyang, fix bug#79441,  2021/05/25  --end
