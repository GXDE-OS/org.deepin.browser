...
//modify by xiaohuyang, Set the width of button.
// constexpr int kMaxIntentPickerLabelButtonWidth = 320;
constexpr int kMaxIntentPickerLabelButtonWidth = 353;
constexpr gfx::Insets kContentMargins(0, 16, 0, 16);
...
//modify by xiaohuyang, Do not display window title and display window icon, 2020/11/12  --start
#if 1
gfx::ImageSkia IntentPickerBubbleView::GetWindowIcon() {
  return *(ui::ResourceBundle::GetSharedInstance().GetImageSkiaNamed(IDR_PERMISSION_PROMPT_BUBBLE_VIEW_ICON));
}
bool IntentPickerBubbleView::ShouldShowWindowIcon() const {
  return true;
}
#endif
...
//modify by xiaohuyang, Do not display window title and display window icon, 2020/11/12  --end
...
IntentPickerBubbleView::IntentPickerBubbleView(
  ...
  //modify by haifengbao, mod The single button color of the pop-up box to gray, 2021/03/15  --start
  if(icon_type_ == PageActionIconType::kIntentPicker)
      DialogDelegate::SetDefaultButton(ui::DIALOG_BUTTON_NONE);
  //modify by haifengbao, mod The single button color of the pop-up box to gray, 2021/03/15  --end
...
void IntentPickerBubbleView::Initialize() {
  ...
  //modify by xiaohuyang, Add title label as dialog title, 2020/11/12  --start
#if 1
  set_margins(kContentMargins);
  
  DCHECK(icon_type_ == PageActionIconType::kIntentPicker);
  base::string16 title_text = l10n_util::GetStringUTF16(IDS_INTENT_PICKER_BUBBLE_VIEW_OPEN_WITH);
  if (icon_type_ == PageActionIconType::kClickToCall) {
...
#endif
  //modify by xiaohuyang, Add title label as dialog title, 2020/11/12  --end
