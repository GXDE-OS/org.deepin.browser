...
void SystemMenuModelBuilder::BuildSystemMenuForBrowserWindow(
  ...
  //modify by xiaohuyang,  Remove TAB bar right-click menu 'use system Title bar and Border' option, 2020/07/10 --start
  // model->AddCheckItemWithStringId(IDC_USE_SYSTEM_TITLE_BAR,
  //                                 IDS_SHOW_WINDOW_DECORATIONS_MENU);
  // model->AddSeparator(ui::NORMAL_SEPARATOR);
  //modify by xiaohuyang,  Remove TAB bar right-click menu 'use system Title bar and Border' option, 2020/07/10 --end
