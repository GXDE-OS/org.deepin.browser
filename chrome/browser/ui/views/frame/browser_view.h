...
#if defined(USE_UNIONTECH_NPAPI)
  views::NpapiPluginMaskObserver* GetNpapiPluginMaskObserver(views::Widget *widget);
  std::set<views::NpapiPluginMaskObserver*> GetNpapiPluginMaskObserverForChildFrame(views::Widget *widget);
#endif
