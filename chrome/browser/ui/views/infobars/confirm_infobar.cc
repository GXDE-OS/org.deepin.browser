...
views::MdTextButton* ConfirmInfoBar::CreateButton(
  ...
  button->SetProperty(
      ...
      gfx::Insets(ChromeLayoutProvider::Get()->GetDistanceMetric(
                  ...
                  0));
  //modify by xiaohuyang, Set the color of the 'ok' or 'cancel' button under different themes,  2020/02/22 --start
  button->SetEnabledTextColors(SK_ColorWHITE);
  //modify by xiaohuyang, Set the color of the 'ok' or 'cancel' button under different themes,  2020/02/22 --end
