...
void ChromeBrowserMainPartsLinux::PostMainMessageLoopStart() {
  ...
  //  唯一声明uos bus 管理类的地方  wzx  add 2020-11-05
  dbus::uos::DBusThreadManager::Initialize();
  //  唯一声明uos bus 管理类的地方  wzx  end 2020-11-05
  
  // modify by xiaohuyang, Initialization of the thread management class of the database. 2021/3/2
  uos::database::DatabaseThreadManager::Initialize();

  uos::customize_tab::CustomizeNewTabsThreadManager::Initialize();
#endif
...
#if !defined(OS_CHROMEOS)
  //  退出 uos bus   wzx  add 2020-11-05
  dbus::uos::DBusThreadManager::Shutdown();
  //  退出 uos bus   wzx  end 2020-11-05
  
  // modify by xiaohuyang, Destroy the thread of the database. 2021/3/2
  uos::database::DatabaseThreadManager::Shutdown();

  bluez::BluezDBusManager::Shutdown();
  bluez::BluezDBusThreadManager::Shutdown();

  uos::customize_tab::CustomizeNewTabsThreadManager::Shutdown();
#endif
