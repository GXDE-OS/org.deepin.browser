...
void ExtensionInfoGenerator::CreateExtensionInfoHelper(
  ...
  info->is_uos_extension_no_delete = !extensions::util::IsUOSExtensionDeletable(extension.id());
  info->is_uos_extension_no_disable = !extensions::util::IsUOSExtensionCanbeDisabled(extension.id());
  info->is_uos_extension_webui_visiable = extensions::util::IsUOSExtensionWebUIVisiable(extension.id());
