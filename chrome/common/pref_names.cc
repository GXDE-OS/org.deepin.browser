...
const char kUsbKeyDirectory[] = "usbkey.default_directory";
...
const char kVideoDecodeAccelerationModeEnabled[] =
  "video_decoder_acceleration_mode.enabled";

const char kVideoDecodeAccelerationModePrevious[] =
  "video_decoder_acceleration_mode_previous";
...
const char kPageZoomLevel[] = "extensions.zoomlevel.id";
...
#ifndef OPENSSL_NO_GMTLS
const char kUsbKeyDriverManager[] = "usb_key_driver_manager";
#endif //#OPENSSL_NO_GMTLS
#if defined(OS_ANDROID)
