...
extern const char kPageZoomLevel[];
...
extern const char kUsbKeyDirectory[];
...
extern const char kVideoDecodeAccelerationModeEnabled[];
extern const char kVideoDecodeAccelerationModePrevious[];
...
#ifndef OPENSSL_NO_GMTLS
extern const char kUsbKeyDriverManager[];
#endif //#OPENSSL_NO_GMTLS
#if defined(OS_ANDROID)
