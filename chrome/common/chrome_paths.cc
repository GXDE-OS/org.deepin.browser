...
#else
    FILE_PATH_LITERAL("/usr/share/browser/extensions");
...
bool PathProvider(int key, base::FilePath* result) {
  ...
  switch (key) {
    ...
    case chrome::FILE_PEPPER_FLASH_SYSTEM_PLUGIN:
      ...
      cur = base::FilePath("/usr/lib/pepperflashplugin-nonfree/libpepflashplayer.so");
#endif
      break;
...
#else
      cur = base::FilePath(FILE_PATH_LITERAL("/etc/browser/policies"));
#endif
      break;
    }
#endif
    ...
    case chrome::FILE_CHROME_OS_TPM_FIRMWARE_UPDATE_SRK_VULNERABLE_ROCA:
      ...
      break;
#endif  // defined(OS_CHROMEOS)
    case chrome::DIR_UOS_DEFAULT_EXTENSIONS:
      cur = base::FilePath("/usr/share/browser/uos-default-extensions");
      break;
    case chrome::DIR_UOS_USR_SHARE_BROWSER:
      cur = base::FilePath("/usr/share/browser");
      break;
