...
//Set chrome debug url 'chrome:xxx' to 'uos:xxx' style
const char kChromeUIQuitHost[] = "quit";
const char kChromeUIQuitURL[] = "chrome://quit/";
//const char kUOSUIQuitURL[] = "uos://quit/";
...
//const char kUOSUIRestartURL[] = "uos://restart/";
...
const char* const kChromeHostURLs[] = {
    ...
    //kChromeUIChromeURLsHost, //disable chrome://chrome-urls
    ...
    //kChromeUIInterstitialHost, //disable chrome://interstitials
    kChromeUIInterventionsInternalsHost,
    kChromeUIInvalidationsHost,
    //kChromeUILocalStateHost, //disable chrome://local-state
#if !defined(OS_ANDROID)
    //kChromeUIManagementHost, //disable chrome://management
#endif
    kChromeUIMediaEngagementHost,
    //kChromeUINetExportHost, //don't show chrome://net-export in about page
    ...
    //kChromeUIPrefsInternalsHost, //don't show chrome://prefs-internal in about page
    kChromeUIQuotaInternalsHost,
    //kChromeUISignInInternalsHost, //disable chrome://signin-internals
    kChromeUISiteEngagementHost,
    //kChromeUINTPTilesInternalsHost, //disable chrome://ntp-tiles-internals
    //safe_browsing::kChromeUISafeBrowsingHost, //disable chrome://safe-browsing
    kChromeUISuggestionsHost,
    kChromeUISupervisedUserInternalsHost,
    //kChromeUISyncInternalsHost, //disable chrome://sync-internals
#if !defined(OS_ANDROID)
    kChromeUITermsHost,
    ...
    //content::kChromeUIHistogramHost, //don't show chrome://histograms in about page
...
#if !defined(OS_ANDROID)
    //content::kChromeUITracingHost, //disable chrome://tracing
#endif
    content::kChromeUIWebRTCInternalsHost,
#if !defined(OS_ANDROID)
#if !defined(OS_CHROMEOS)
    //kChromeUIAppLauncherPageHost, //disable chrome://apps
#endif
...
#if 0
const char* const kUOSDebugURLs[] = {
    content::kUOSUIBadCastCrashURL,
    content::kUOSUIBrowserCrashURL,
    content::kUOSUICrashURL,
    content::kUOSUIDumpURL,
    content::kUOSUIKillURL,
    content::kUOSUIHangURL,
    content::kUOSUIShorthangURL,
    content::kUOSUIGpuCleanURL,
    content::kUOSUIGpuCrashURL,
    content::kUOSUIGpuHangURL,
    content::kUOSUIMemoryExhaustURL,
    content::kUOSUIMemoryPressureCriticalURL,
    content::kUOSUIMemoryPressureModerateURL,
    content::kUOSUIPpapiFlashCrashURL,
    content::kUOSUIPpapiFlashHangURL,
#if defined(OS_WIN)
