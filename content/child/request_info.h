...
#ifndef CONTENT_CHILD_REQUEST_INFO_
#define CONTENT_CHILD_REQUEST_INFO_
...
struct CONTENT_EXPORT RequestInfo {
  ...
  network::mojom::CredentialsMode fetch_credentials_mode;

  // The redirect mode used in Fetch API.
  network::mojom::RedirectMode fetch_redirect_mode;
  ...
  scoped_refptr<blink::WebURLRequest::ExtraData> extra_data;
  ...
  // decide.
  blink::WebURLRequest::PreviewsState previews_state;
...
#endif  // CONTENT_CHILD_REQUEST_INFO_
