...
class CONTENT_EXPORT MultipartResponseDelegate {
 public:
  ...
  MultipartResponseDelegate(blink::WebAssociatedURLLoaderClient* client,
                            blink::WebAssociatedURLLoader* loader,
                            const blink::WebURLResponse& response,
                            const std::string& boundary);                            
 ...
 private:
  ...
  blink::WebAssociatedURLLoader* loader_;
  blink::WebAssociatedURLLoaderClient* client_;
