...
bool PluginChannelHost::Init(base::SingleThreadTaskRunner* task_runner,
                             bool create_pipe_now,
                             base::WaitableEvent* shutdown_event) {
  LOG(INFO)<<"----------------[NPAPI]PluginChannelHost Init-------------";
  return NPChannelBase::Init(task_runner, create_pipe_now, shutdown_event);
}
...
void PluginChannelHost::AddRoute(int route_id, IPC::Listener* listener, NPObjectBase* npobject) {
