...
struct PluginMsg_FetchedURL_Params;
...
class WebPluginDelegateStub : public IPC::Listener,
 ...
 private:
  ...
  void OnDidReceiveData(int id, const std::vector<char>& buffer, int data_offset);
  ...
  void OnFetchedURL(const PluginMsg_FetchedURL_Params& params);
