...
std::string BuildUserAgentFromOSAndProduct(const std::string& os_info,
  ...
  //modify by xiaohuyang, Set the user-agent field on the version page, 2020/07/23 --start
#if UNUSE
  base::StringAppendF(
      &user_agent,
  ...
  // user_agent = "Mozilla/5.0 (X11; Linux/browser x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.116 Safari/537.36";
  //modify by xiaohuyang, Set the user-agent field on the version page, 2020/07/23 --end
  #else
  //modify by wangfeng, Set the user-agent field on the version page, bug(54349) 2020/11/13 --start
  base::StringAppendF(
      &user_agent,
      "Mozilla/5.0 (%s) AppleWebKit/%d.%d (KHTML, like Gecko) Chrome/83.0.4103.116 Safari/%d.%d UOS",
      os_info.c_str(),
      WEBKIT_VERSION_MAJOR,
      WEBKIT_VERSION_MINOR,
      WEBKIT_VERSION_MAJOR,
      WEBKIT_VERSION_MINOR);
  //modify by wangfeng, Set the user-agent field on the version page, bug(54349) 2020/11/13 --end
#endif
