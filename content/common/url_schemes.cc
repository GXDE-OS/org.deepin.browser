...
void RegisterContentSchemes() {
  ...
  // url::AddStandardScheme(kUosUIScheme, url::SCHEME_WITH_HOST);
  ...
  // schemes.secure_schemes.push_back(kUosUIScheme);
  ...
  // schemes.cors_enabled_schemes.push_back(kUosUIScheme);
