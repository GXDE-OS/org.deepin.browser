...
class CONTENT_EXPORT URLLoaderFactoryImpl final
 ...
 public:
  ...
  void CreateLoaderAndStart(mojo::PendingReceiver<network::mojom::URLLoader> request,
                            int32_t routing_id,
                            int32_t request_id,
                            uint32_t options,
  ...
  void Clone(mojo::PendingReceiver<network::mojom::URLLoaderFactory> request) override;
