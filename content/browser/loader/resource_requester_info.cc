...
void GetContextsCallbackForNavigationPreload(
  ...
  *request_context_out = nullptr;
  LOG(ERROR) << "[RES][TODO]GetRequestContext NOT IMPLEMENT!!!";
}
...
#if defined(USE_UNIONTECH_NPAPI)
  get_contexts_callback_.Run(resource_type, origin_pid, resource_context, request_context);
#else
