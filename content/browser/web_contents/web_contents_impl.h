...
class CONTENT_EXPORT WebContentsImpl : public WebContents,
 ...
 public:
  ...
  //const GURL& GetVisibleURLForUOS() override;
  ...
  std::set<RenderWidgetHostView*> GetRenderWidgetChildFrameView() override;
  ...
  void DispatchUosCustomizedEvent() override;
  ...
  void RunBeforeUnloadConfirmForBankAndIRC(RenderFrameHost* render_frame_host,
                                           bool is_reload,
                                           bool is_tab_close,
