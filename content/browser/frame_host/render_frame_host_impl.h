...
class CONTENT_EXPORT RenderFrameHostImpl
 ...
 public:
  ...
  //const GURL& GetLastCommittedURLForUOS() override;
  ...
  void DispatchUosCustomizedEvent();
  ...
  void RunBeforeUnloadConfirmForBankAndIRC(bool is_reload,
                                           const base::string16& bank,
                                           const base::string16& message,
                                           RunBeforeUnloadConfirmForBankAndIRCCallback callback) override;
 ...
 protected:
  ...
  virtual void SendUosCustomize(base::WeakPtr<RenderFrameHostImpl> impl);
 ...
 private:
  ...
  void ProcessUosCustomizeCompleted(
      bool proceed,
      bool treat_as_final_completion_callback,
