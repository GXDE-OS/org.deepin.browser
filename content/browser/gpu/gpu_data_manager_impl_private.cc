...
void GpuDataManagerImplPrivate::SetVideoDecodeAcceleration(bool video_decode) {
  video_decode_disabled_explicitly_ = !video_decode;
}

bool GpuDataManagerImplPrivate::VideoDecodeAccelerationEnabled() const {
  return !video_decode_disabled_explicitly_;
}
