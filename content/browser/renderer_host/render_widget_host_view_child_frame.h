...
class CONTENT_EXPORT RenderWidgetHostViewChildFrame
 ...
 public:
  ...
  void OnCreatePluginContainer(gfx::PluginWindowHandle id) override;
  void OnDestroyPluginContainer(gfx::PluginWindowHandle id) override;
  void OnWindowActiveStatusChanged(bool active) override;
...
#if defined(USE_UNIONTECH_NPAPI)
  views::NpapiPluginMaskObserver* GetNpapiPluginMaskObserver(views::Widget *widget) override;
  gfx::AcceleratedWidget GetHostWindow() const;
#endif
...
#if defined(USE_UNIONTECH_NPAPI)
  std::unique_ptr<GtkPluginContainerManager> plugin_container_manager_;
#endif
