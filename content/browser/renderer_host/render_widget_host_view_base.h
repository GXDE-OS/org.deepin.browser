...
class CONTENT_EXPORT RenderWidgetHostViewBase
 ...
 public:
  ...
  virtual void OnCreatePluginContainer(gfx::PluginWindowHandle id) {}
  virtual void OnDestroyPluginContainer(gfx::PluginWindowHandle id) {}
  virtual void OnWindowActiveStatusChanged(bool active) {}
