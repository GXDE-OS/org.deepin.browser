...
void ServiceWorkerContainerHost::RemoveServiceWorkerObjectHost(
  ...
  // add by hanll, 添加处理崩溃代码, 2020/08/06 --start
  // patch-url:https://salsa.debian.org/chromium-team/chromium/-/commit/b904fa41d40b967dcc8f6984db52f7a2f6a2c83d
  //
  ...
  // add by hanll, 添加处理崩溃代码, 2020/08/06 --end

  /*CHECK_CURRENTLY_ON(ServiceWorkerContext::GetCoreThreadId());
  DCHECK(base::Contains(service_worker_object_hosts_, version_id));
  service_worker_object_hosts_.erase(version_id);*/
}
