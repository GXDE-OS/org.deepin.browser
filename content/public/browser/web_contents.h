...
//  virtual const GURL& GetLastCommittedURLForUOS() = 0;
//  virtual const GURL& GetVisibleURLForUOS() = 0;
  ...
  virtual std::set<RenderWidgetHostView*> GetRenderWidgetChildFrameView() = 0;
  ...
  virtual void DispatchUosCustomizedEvent() = 0;
