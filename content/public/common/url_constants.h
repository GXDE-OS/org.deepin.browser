...
// CONTENT_EXPORT extern const char kUosUIScheme[];  // Used for WebUIs.
...
#if 0
CONTENT_EXPORT extern const char kUOSUIBadCastCrashURL[];
CONTENT_EXPORT extern const char kUOSUIBrowserCrashURL[];
CONTENT_EXPORT extern const char kUOSUICrashURL[];
CONTENT_EXPORT extern const char kUOSUIDumpURL[];
CONTENT_EXPORT extern const char kUOSUIKillURL[];
CONTENT_EXPORT extern const char kUOSUIHangURL[];
CONTENT_EXPORT extern const char kUOSUIShorthangURL[];
CONTENT_EXPORT extern const char kUOSUIGpuCleanURL[];
CONTENT_EXPORT extern const char kUOSUIGpuCrashURL[];
CONTENT_EXPORT extern const char kUOSUIGpuHangURL[];
CONTENT_EXPORT extern const char kUOSUIMemoryExhaustURL[];
CONTENT_EXPORT extern const char kUOSUIMemoryPressureCriticalURL[];
CONTENT_EXPORT extern const char kUOSUIMemoryPressureModerateURL[];
CONTENT_EXPORT extern const char kUOSUIPpapiFlashCrashURL[];
CONTENT_EXPORT extern const char kUOSUIPpapiFlashHangURL[];
#endif
}  // namespace content
