...
//Get the UOS Edition if we can, or return "Unknown"
BASE_EXPORT std::string GetUosEdition();
...
//wangfeng, add, 2020/12/15
// Set the UOS Editon string.
BASE_EXPORT void SetUosEdition(const std::string& distro);
