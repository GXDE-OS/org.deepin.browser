...
//static int gm_mode_ = USE_GM_MODE;
...
// GMTLS
#ifndef OPENSSL_NO_GMTLS
    {GMTLS_VERSION,  SSL_OP_NO_TLSv1_3},
#endif
...
// GMTLS
#ifndef OPENSSL_NO_GMTLS	  
	  protocol_version != GMTLS_VERSION &&
#endif 
...
// GMTLS
#ifndef OPENSSL_NO_GMTLS
static int gm_mode_ = -1;

bool SSL_set_gm_mode(int mode)
{
  //gm_mode_ = mode;
  //return true;
  int segment_id = shmget (36195, sizeof(int), 0644 | IPC_CREAT);
  ...
  void* data = shmat(segment_id, NULL, 0);
  if (data == (char*)(-1)) 
  {
    return false;
  }
...
int SSL_get_gm_mode()
{
  ...
  int segment_id = shmget (36195, sizeof(int), 0644);
