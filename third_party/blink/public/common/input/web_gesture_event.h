...
class BLINK_COMMON_EXPORT WebGestureEvent : public WebInputEvent {
 ...
 public:
  WebGestureEvent(Type type,
      ...
      : WebInputEvent(sizeof(WebGestureEvent), type, modifiers, time_stamp), source_device_(device) {
    memset(&data, 0, sizeof(data));
  }

  WebGestureEvent() : WebInputEvent(sizeof(WebGestureEvent)) { memset(&data, 0, sizeof(data)); }
