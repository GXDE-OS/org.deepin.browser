...
class BLINK_COMMON_EXPORT WebMouseEvent : public WebInputEvent,
 ...
 public:
  ...
  WebMouseEvent(Type type_param,
      ...
      : WebInputEvent(sizeof(WebMouseEvent), type_param, modifiers_param, time_stamp_param),
 ...
 protected:
  WebMouseEvent(PointerId id_param) : WebInputEvent(sizeof(WebMouseEvent)), WebPointerProperties(id_param) {}
