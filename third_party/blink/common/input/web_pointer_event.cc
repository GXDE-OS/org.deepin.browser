...
WebPointerEvent::WebPointerEvent(const WebTouchEvent& touch_event,
    ...
    : WebInputEvent(sizeof(WebPointerEvent), PointerEventTypeForTouchPointState(touch_point.state),
...
WebPointerEvent::WebPointerEvent(WebInputEvent::Type type,
    ...
    : WebInputEvent(sizeof(WebPointerEvent), type, mouse_event.GetModifiers(), mouse_event.TimeStamp()),
