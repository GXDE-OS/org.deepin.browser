...
// modify by xiaohuyang, 2021/5/7  --start
// Allows Web Components v0 to be enabled like 360 browser,can improve 4 points for html5 test.
#if UNUSED
...
const base::Feature kWebComponentsV0Enabled{"WebComponentsV0Enabled",
                                            base::FEATURE_ENABLED_BY_DEFAULT};
#endif
// modify by xiaohuyang, 2021/5/7  --end
