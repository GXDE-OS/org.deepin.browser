...
class CORE_EXPORT LocalFrame final : public Frame,
 ...
 public:
  ...
  IntRect RemoteViewportIntersection() const {
    return IntRect(intersection_state_.viewport_intersection.x,
                   intersection_state_.viewport_intersection.y,
                   intersection_state_.viewport_intersection.width,
                   intersection_state_.viewport_intersection.height);
  }
  IntRect RemoteMainFrameDocumentIntersection() const {
    return IntRect(intersection_state_.main_frame_document_intersection.x,
                   intersection_state_.main_frame_document_intersection.y,
                   intersection_state_.main_frame_document_intersection.width,
                   intersection_state_.main_frame_document_intersection.height);
  }
  ...
  void UosCustomize(UosCustomizeCallback callback) final;
