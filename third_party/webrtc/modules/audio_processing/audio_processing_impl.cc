...
AudioProcessingImpl::AudioProcessingImpl(
  ...
  RTC_LOG(LS_INFO) << "Echo control factory: " << !!echo_control_factory_;
  RTC_LOG(LS_INFO) << "Echo detector: " << !!submodules_.echo_detector;
  RTC_LOG(LS_INFO) << "Capture analyzer: " << !!submodules_.capture_analyzer;
  RTC_LOG(LS_INFO) << "Capture post processor: " << !!submodules_.capture_post_processor;
  RTC_LOG(LS_INFO) << "Render pre processor: " << !!submodules_.render_pre_processor;
