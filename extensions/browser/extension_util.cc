...
bool CanBeIncognitoEnabled(const Extension* extension) {
  if (!IsUOSExtensionIncognitoDisabled(extension->id())) {
    return true;
  }
...
bool IsIncognitoEnabled(const std::string& extension_id,
  ...
  if (extension) {
    if (!IsUOSExtensionIncognitoDisabled(extension_id))
      return true;
...
bool IsUOSDefaultExtension(const std::string& extension_id) {
  return crx_file::GetUOSDefaultExtensionProperty(crx_file::UOSExtensionProperty::ID_EXIST, extension_id);
}

bool IsUOSExtensionToolbarVisiable(const std::string& extension_id)
{
  return crx_file::GetUOSDefaultExtensionProperty(crx_file::UOSExtensionProperty::TOOLBAR_VISIABLE, extension_id);
}

bool IsUOSExtensionWebUIVisiable(const std::string& extension_id)
{
  return crx_file::GetUOSDefaultExtensionProperty(crx_file::UOSExtensionProperty::WEBUI_VISIABLE, extension_id);
}

bool IsUOSExtensionDeletable(const std::string& extension_id)
{
  return crx_file::GetUOSDefaultExtensionProperty(crx_file::UOSExtensionProperty::CAN_BE_DELETE, extension_id);
}

bool IsUOSExtensionCanbeDisabled(const std::string& extension_id)
{
  return crx_file::GetUOSDefaultExtensionProperty(crx_file::UOSExtensionProperty::CAN_BE_DISABLE, extension_id);
}

bool IsUOSExtensionToolbarContextMenuEnabled(const std::string& extension_id)
{
  return crx_file::GetUOSDefaultExtensionProperty(crx_file::UOSExtensionProperty::TOOLBAR_CONTEXT_MENU, extension_id);
}

bool IsUOSExtensionIncognitoDisabled(const std::string& extension_id)
{
  return crx_file::GetUOSDefaultExtensionProperty(crx_file::UOSExtensionProperty::INCOGNITO_DISABLE, extension_id);
}
