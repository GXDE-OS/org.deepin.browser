...
ScriptContext::~ScriptContext() {
  ...
  VLOG(1) << "extension id: " << GetExtensionID();
  VLOG(1) << "effective extension id: "
...
void ScriptContext::OutputDebugString() {
  DCHECK(thread_checker_.CalledOnValidThread());
  VLOG(1) << "Created context:";
  VLOG(1) << base::StringPrintf("extension id: %s", extension_.get() ? extension_->id().c_str() : "(none)");
  VLOG(1) << base::StringPrintf("frame: %p", web_frame_);
  VLOG(1) << base::StringPrintf("URL: %s", url_.spec().c_str());
  VLOG(1) << base::StringPrintf("context_type: %s", GetContextTypeDescription().c_str());
  VLOG(1) << base::StringPrintf("effective extension id: %s", effective_extension_.get() ? effective_extension_->id().c_str() : "(none)");
  VLOG(1) << base::StringPrintf("effective context type: %s", GetEffectiveContextTypeDescription().c_str());
}
