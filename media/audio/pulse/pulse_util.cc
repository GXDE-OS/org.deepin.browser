...
#else
//modify by xiaohuyang, Adjust the name and icon displayed when the browser is playing audio.  2021/3/30
constexpr char kBrowserDisplayName[] = "org.deepin.browser";
#define PRODUCT_STRING "浏览器"
#endif
